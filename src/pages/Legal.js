...
import { Award, Shield, Lock, ArrowRight, CheckCircle, Menu, X, Download } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-white">
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <nav className="flex items-center space-x-6">
              ...
              <Link to="/legal" className="text-white font-medium">Legal</Link>
            </nav>
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 border-t border-purple-700">
            <nav className="flex flex-col space-y-4 mt-4">
              ...
              <Link to="/legal" className="text-white font-medium" onClick={() => setIsMenuOpen(false)}>Legal</Link>
      ...
      <div className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-5xl font-bold text-center mb-8">Legal & <span className="text-red-400">Compliance</span></h1>
          <p className="text-xl text-purple-200 text-center mb-12 max-w-4xl mx-auto">
            GlobalPay operates with full regulatory compliance and the highest legal standards to protect our users and maintain trust.
          </p>

          {/* Licenses & Compliance */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-center mb-8">Licenses & Regulations</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-purple-800 bg-opacity-60 rounded-lg p-6 backdrop-blur-sm border border-purple-600">
                ...
                <h3 className="text-xl font-bold mb-4">Money Transmission License</h3>
                <p className="text-purple-200 mb-4">Licensed in all 50 US states and territories</p>
                <ul className="text-sm text-purple-300 space-y-1">
                  <li>• FinCEN MSB Registration</li>
                  <li>• State-by-state licensing</li>
                  <li>• Regular compliance audits</li>
                  <li>• NMLS registry listed</li>
                </ul>
              </div>

              <div className="bg-purple-800 bg-opacity-60 rounded-lg p-6 backdrop-blur-sm border border-purple-600">
                <Shield className="text-green-400 mb-4" size={32} />
                <h3 className="text-xl font-bold mb-4">International Compliance</h3>
                <p className="text-purple-200 mb-4">Authorized by central banks in 45+ countries</p>
                <ul className="text-sm text-purple-300 space-y-1">
                  <li>• EU PSD2 Compliance</li>
                  <li>• UK FCA Authorization</li>
                  <li>• Canadian FINTRAC</li>
                  <li>• AUSTRAC Australia</li>
                </ul>
              </div>
              ...
              <div className="bg-purple-800 bg-opacity-60 rounded-lg p-6 backdrop-blur-sm border border-purple-600">
                ...
                <p className="text-purple-200 mb-4">Industry-leading security certifications</p>
                <ul className="text-sm text-purple-300 space-y-1">
          ...
          {/* Legal Documents */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-center mb-8">Legal Documents</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="bg-purple-800 bg-opacity-60 rounded-lg p-6 backdrop-blur-sm border border-purple-600 hover:border-blue-500 transition-all duration-300 cursor-pointer">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-lg font-bold">Privacy Policy</h3>
                      <p className="text-purple-300 text-sm">How we collect, use, and protect your data</p>
                      <p className="text-xs text-purple-400">Last updated: January 2025</p>
                    </div>
                ...
                <div className="bg-purple-800 bg-opacity-60 rounded-lg p-6 backdrop-blur-sm border border-purple-600 hover:border-blue-500 transition-all duration-300 cursor-pointer">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-purple-300 text-sm">Legal agreement governing platform use</p>
                      <p className="text-xs text-purple-400">Last updated: January 2025</p>
                    </div>
                    <ArrowRight size={20} className="text-blue-400" />
                  </div>
              ...
              <div className="space-y-4">
                <div className="bg-purple-800 bg-opacity-60 rounded-lg p-6 backdrop-blur-sm border border-purple-600 hover:border-blue-500 transition-all duration-300 cursor-pointer">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-purple-300 text-sm">Our approach to regulatory compliance</p>
                      <p className="text-xs text-purple-400">Last updated: December 2024</p>
                    </div>
                    <ArrowRight size={20} className="text-blue-400" />
                  </div>
                </div>
                ...
                <div className="bg-purple-800 bg-opacity-60 rounded-lg p-6 backdrop-blur-sm border border-purple-600 hover:border-blue-500 transition-all duration-300 cursor-pointer">
                  <div className="flex justify-between items-center">
                    <div>
                      <h3 className="text-lg font-bold">License Registry</h3>
                      <p className="text-purple-300 text-sm">Complete list of our regulatory licenses</p>
                      <p className="text-xs text-purple-400">Updated monthly</p>
                    </div>
                    <ArrowRight size={20} className="text-blue-400" />
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-r from-red-900 to-purple-900 rounded-lg p-8 border border-red-500">
            <h2 className="text-3xl font-bold text-center mb-6">Our Regulatory Commitment</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-bold mb-4">Transparency</h3>
                <p className="text-purple-200 mb-4">
                  We maintain complete transparency in our operations, publishing regular 
                  compliance reports and working closely with regulators worldwide.
                </p>
                <ul className="text-purple-200 space-y-2">
                  <li className="flex items-center"><CheckCircle size={16} className="text-green-400 mr-2" />Quarterly compliance reports</li>
                  <li className="flex items-center"><CheckCircle size={16} className="text-green-400 mr-2" />Real-time transaction monitoring</li>
                  <li className="flex items-center"><CheckCircle size={16} className="text-green-400 mr-2" />Customer fund segregation</li>
                </ul>
              </div>
              <div>
                <h3 className="text-xl font-bold mb-4">User Protection</h3>
                <p className="text-purple-200 mb-4">
                  Your funds and data are protected by comprehensive legal frameworks 
                  and insurance coverage up to $250,000 per account.
                </p>
                <div className="text-center mt-6">
                  <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg font-bold transition-all duration-300">
