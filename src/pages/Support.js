...
import { PhoneCall, Mail, Globe, ArrowRight, ChevronRight, Menu, X, Download } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-white">
        ...
        {isMenuOpen && (
          <div className="lg:hidden mt-4 pb-4 border-t border-purple-700">
            <nav className="flex flex-col space-y-4 mt-4">
              ...
              <Link to="/support" className="text-white font-medium" onClick={() => setIsMenuOpen(false)}>Support</Link>
      ...
      <div className="pt-20 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          <h1 className="text-5xl font-bold text-center mb-8">Customer <span className="text-green-400">Support</span></h1>
          <p className="text-xl text-purple-200 text-center mb-12 max-w-4xl mx-auto">
            We're here to help 24/7. Get instant support through multiple channels or explore our comprehensive resources.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-purple-800 bg-opacity-60 rounded-lg p-8 backdrop-blur-sm border border-purple-600 text-center hover:border-green-500 transition-all duration-300">
              <PhoneCall className="text-green-400 mx-auto mb-4" size={48} />
              <h3 className="text-xl font-bold mb-4">24/7 Phone Support</h3>
              <p className="text-purple-200 mb-4">Speak directly with our expert support team</p>
              <div className="text-lg font-bold text-green-400">+1-800-GLOBALPAY</div>
              <div className="text-sm text-purple-300">Available worldwide</div>
            </div>
            ...
            <div className="bg-purple-800 bg-opacity-60 rounded-lg p-8 backdrop-blur-sm border border-purple-600 text-center hover:border-blue-500 transition-all duration-300">
              ...
              <p className="text-purple-200 mb-4">Get detailed help via email</p>
              <div className="text-lg font-bold text-blue-400">support@globalpay.com</div>
              <div className="text-sm text-purple-300">Response within 1 hour</div>
            </div>
            ...
            <div className="bg-purple-800 bg-opacity-60 rounded-lg p-8 backdrop-blur-sm border border-purple-600 text-center hover:border-yellow-500 transition-all duration-300">
              <Globe className="text-yellow-400 mx-auto mb-4" size={48} />
              <h3 className="text-xl font-bold mb-4">Live Chat</h3>
              <p className="text-purple-200 mb-4">Instant messaging with support agents</p>
              <button className="bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-2 rounded-lg font-bold transition-all duration-300">
                Start Chat
              </button>
              <div className="text-sm text-purple-300 mt-2">Average wait: 30 seconds</div>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { title: "Getting Started", desc: "Account setup and verification guide", articles: 12 },
                { title: "Sending Money", desc: "Step-by-step transfer instructions", articles: 8 },
                { title: "Crypto Cards", desc: "How to purchase and activate cards", articles: 6 },
                { title: "Security", desc: "Account security and fraud prevention", articles: 10 },
                { title: "Fees & Rates", desc: "Understanding our pricing structure", articles: 5 },
                { title: "Troubleshooting", desc: "Common issues and solutions", articles: 15 }
              ].map((category, index) => (
                <div key={index} className="bg-purple-800 bg-opacity-60 rounded-lg p-6 backdrop-blur-sm border border-purple-600 hover:border-blue-500 transition-all duration-300 cursor-pointer">
                  ...
                  <p className="text-purple-200 text-sm mb-3">{category.desc}</p>
                  <div className="flex justify-between items-center">
                    <span className="text-xs text-purple-300">{category.articles} articles</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3 text-purple-200">
                  <li className="flex items-center"><ChevronRight size={16} className="text-blue-400 mr-2" />RESTful API Reference</li>
                  <li className="flex items-center"><ChevronRight size={16} className="text-blue-400 mr-2" />SDK & Libraries</li>
                  <li className="flex items-center"><ChevronRight size={16} className="text-blue-400 mr-2" />Webhook Documentation</li>
                  <li className="flex items-center"><ChevronRight size={16} className="text-blue-400 mr-2" />Sandbox Environment</li>
                  <li className="flex items-center"><ChevronRight size={16} className="text-blue-400 mr-2" />Code Examples</li>
                </ul>
              </div>
              <div>
                <h3 className="text-xl font-bold mb-4">Integration Support</h3>
                <p className="text-purple-200 mb-4">
                  Our developer support team helps you integrate GlobalPay APIs quickly and efficiently.
                </p>
                <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-bold transition-all duration-300 mr-4">
                  View API Docs
                </button>
                <button className="bg-transparent border-2 border-blue-400 text-blue-400 px-6 py-3 rounded-lg font-bold hover:bg-blue-400 hover:text-white transition-all duration-300">
                  Contact Dev Support
                </button>
              </div>
            </div>
